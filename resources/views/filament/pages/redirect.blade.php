    ...
    <div class="flex items-center justify-center p-8">
        <div class="text-center">
            ...
            <div class="flex justify-center">
                ...
                <a href="{{ \App\Filament\Resources\PartialVisitorRestrictionResource::getUrl('create') }}" class="text-primary-500 hover:underline">Clique aqui se não for redirecionado automaticamente</a>
            </div>
        </div>
    </div>
</x-filament::page>
...
<script>
    ...
    setTimeout(function() {
        window.location.href = "{{ \App\Filament\Resources\PartialVisitorRestrictionResource::getUrl('create') }}";
    }, 1500);
</script>
